...
add_action( 'init', 'create_test_hierarchical_taxonomy', 0 );

//create a custom taxonomy name it test for your posts
...
//first do the translations part for GUI
  ...
  $labels = array(
    ...
    'singular_name' => _x( 'Testimonials Categories', 'taxonomy singular name' ),
...
// Now register the taxonomy
  ...
  register_taxonomy('testimonials',array('testimonials'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
